...
namespace XLua.CSObjectWrap
{
    ...
    public class XGUIXTouchClickWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XGUI.XTouchClick);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					XGUI.XTouchClick gen_ret = new XGUI.XTouchClick();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XGUI.XTouchClick constructor!");
        ...
        static int _m_OnPointerClick(RealStatePtr L)
        {
		    try {
                ...
                XGUI.XTouchClick gen_to_be_invoked = (XGUI.XTouchClick)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_onClick(RealStatePtr L)
        {
		    try {
                ...
                XGUI.XTouchClick gen_to_be_invoked = (XGUI.XTouchClick)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onClick = translator.GetDelegate<UnityEngine.Events.UnityAction<UnityEngine.EventSystems.PointerEventData>>(L, 2);
