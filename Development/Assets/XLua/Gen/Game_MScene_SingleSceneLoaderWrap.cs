...
namespace XLua.CSObjectWrap
{
    ...
    public class GameMSceneSingleSceneLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.MScene.SingleSceneLoader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.MScene.SingleSceneLoader gen_ret = new Game.MScene.SingleSceneLoader();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.MScene.SingleSceneLoader constructor!");
        ...
        static int _g_get_UCamera(RealStatePtr L)
        {
		    try {
                ...
                Game.MScene.SingleSceneLoader gen_to_be_invoked = (Game.MScene.SingleSceneLoader)translator.FastGetCSObj(L, 1);
