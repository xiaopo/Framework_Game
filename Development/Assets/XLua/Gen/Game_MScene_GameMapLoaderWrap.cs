...
namespace XLua.CSObjectWrap
{
    ...
    public class GameMSceneGameMapLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.MScene.GameMapLoader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.MScene.GameMapLoader gen_ret = new Game.MScene.GameMapLoader();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.MScene.GameMapLoader constructor!");
        ...
        static int _m_Preload(RealStatePtr L)
        {
		    try {
                ...
                Game.MScene.GameMapLoader gen_to_be_invoked = (Game.MScene.GameMapLoader)translator.FastGetCSObj(L, 1);
        ...
        static int _m_LoadClamp(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& translator.Assignable<Game.MScene.LoadMapMode>(L, 4)) 
                {
                    float _clampTime = (float)LuaAPI.lua_tonumber(L, 2);
                    string _assetName = LuaAPI.lua_tostring(L, 3);
                    Game.MScene.LoadMapMode _loadType;translator.Get(L, 4, out _loadType);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.MScene.GameMapLoader.LoadClamp!");
        ...
        static int _m_Load(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<Game.MScene.LoadMapMode>(L, 3)) 
                {
                    string _assetName = LuaAPI.lua_tostring(L, 2);
                    Game.MScene.LoadMapMode _loadType;translator.Get(L, 3, out _loadType);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.MScene.GameMapLoader.Load!");
        ...
        static int _m_Unload(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.MScene.GameMapLoader.Unload!");
