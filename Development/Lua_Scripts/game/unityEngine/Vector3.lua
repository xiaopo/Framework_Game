...
function Vector3.DistanceVal(x1,y1,z1,x2,y2,z2)
...
--忽略y轴的计算
function Vector3.Angle2D(from, to)
	local from2 = Vector3.New(from.x,0,from.z);
	local to2 = Vector3.New(from.x,0,from.z);
	return acos(clamp(dot(from2:Normalize(), to2:Normalize()), -1, 1)) * rad2Deg
end
...
_get.up         = function() return _new(0,1,0) end
_get.down   = function() return _new(0,-1,0) end
_get.right  = function() return _new(1,0,0) end
_get.left   = function() return _new(-1,0,0) end
_get.forward = function() return _new(0,0,1) end
_get.back   = function() return _new(0,0,-1) end
_get.zero   = function() return _new(0,0,0) end
_get.one        = function() return _new(1,1,1) end

_get.magnitude  = Vector3.Magnitude
_get.normalized = Vector3.Normalize
_get.sqrMagnitude= Vector3.SqrMagnitude
